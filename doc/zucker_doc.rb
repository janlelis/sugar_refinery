...
<body>
  <div id="world">
    ...
    <h1>Ruby Zucker ..version..</h1>
      ...
      <p class="text">The gem consists of many small snippets, called <em>cubes</em>, which are bundled in <em>packages</em>. Since there aren't any dependencies within the gem, you can easily require only the packages or cubes you wan:
