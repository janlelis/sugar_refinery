...
<body>
  <div id="world">
    ...
    <h1>Ruby Zucker ..version..</h1>
      ...
      <code class="scode">Info, RubyVersion, RubyEngine, OS, Infinity, NaN, alias_for, aliases_for, egonil, nn, iterate, instance_variables_from, ivars, tap_on, make_new, (blank?, present?, mcopy)</code>
      </p>
