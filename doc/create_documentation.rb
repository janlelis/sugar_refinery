...
<body>
  <div id="world">
    ...
    <br/>
    <p class="text">Zucker (<a href="http://www.forvo.com/word/zucker/">pronunciation</a>) is the German word for sugar. It adds syntactic sugar in the form of independent, small scripts that sweeten Ruby even more. It uses Ruby's <a href="#123">refinements</a> feature, so you can actively choose, whether you want to include a feature in a Ruby source file. Core extensions will be used, if your Ruby version does not support refinements. The source is available at <a href="https://github.com/janlelis/zucker">github</a>.</p>
    ...
    <p class="text">
      You can then choose to use one feature ('sugar cube') in one Ruby file:
      <code class="scode">using Zucker::CubeName</code>
    </p>
