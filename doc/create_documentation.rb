...
<body>
  <div id="world">
    ...
    <p class="text">
      <code class="scode">require 'sugar_refinery/all'</code>
    </p>
...
Hash.zip [1,2,3], [4,5,6] # => {1=>4, 2=>5, 3=>6}</pre>
  ...
  <div id="foot">
    ...
    Source at <a href="https://github.com/janlelis/sugar_refinery">github</a>.
